/* -*- Mode:C++; c-file-style:"gnu"; indent-tabs-mode:nil; -*- */
 ...
 public:
   ...
   Ipv6InterfaceContainer interfacesipv6;
 ...
 UanExperiment::SetupCommunications ()
 {
   ...
   sixlowpanNetDevices = sixLowPanHelper.Install (netDeviceContainer);
   ...
   interfacesipv6 = ipv6AddressHelper.Assign (sixlowpanNetDevices);
 ...
 main (int argc, char *argv[])
 {
   ...
   p2pnodes.Add(fog1.m_nodes.Get(0));
   p2pnodes.Add(fog2.m_nodes.Get(0));
   ...
   UdpEchoClientHelper echoClient (fog2.interfacesipv6.GetAddress (0,0), 63);
